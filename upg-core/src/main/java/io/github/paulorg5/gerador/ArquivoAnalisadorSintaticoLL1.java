...
public class ArquivoAnalisadorSintaticoLL1 extends AbstractArquivo implements Arquivo {

	private static final String CAMINHO_TEMPLATE = "templates_arquivos/analisador_sintatico_java.txt";

	private static final String CAMINHO_NO_ZIP = "src/main/java/";

	private static final String PACOTE = ".sintatico";

	private static final String NOME_ARQUIVO = "AnalisadorSintatico.java";

	private ConteudoHeader conteudoHeader;
	
	public ArquivoAnalisadorSintaticoLL1(ConteudoHeader conteudoHeader) {
