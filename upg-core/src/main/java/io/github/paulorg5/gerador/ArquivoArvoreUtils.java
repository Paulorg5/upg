...
public class ArquivoArvoreUtils extends AbstractArquivo implements Arquivo {

	private static final String CAMINHO_TEMPLATE = "templates_arquivos/arvore_utils_java.txt";

	private static final String CAMINHO_NO_ZIP = "src/main/java/";
	
	private static final String PACOTE = ".utils";

	private static final String NOME_ARQUIVO = "ArvoreUtils.java";

	private ConteudoHeader conteudoHeader;
	
	public ArquivoArvoreUtils(ConteudoHeader conteudoHeader) {
